...
exports.createNewIdeaEmailTemplate = createNewIdeaEmailTemplate;
exports.createNewEventEmailTemplate = createNewEventEmailTemplate;
exports.createTestEmailTemplate = createTestEmailTemplate;
exports.createNewMemberProposalEmailTemplate = createNewMemberProposalEmailTemplate;
exports.createNewLoanItemEmailTemplate = createNewLoanItemEmailTemplate;
...
function createNewIdeaEmailTemplate(idea, proposedBy, context) {
    ...
    <body style="margin: 0; padding: 20px; background-color: #f5f5f5;">
      <div style="${emailStyles.container}">
        <header style="${emailStyles.header}">
          <h1 style="${emailStyles.title}">${(0, branding_core_1.getShortAppName)()}</h1>
        ...
        <footer style="${emailStyles.footer}">
          ${branding_core_1.brandingCore.organization.fullName}<br>
...
function createNewEventEmailTemplate(event, organizer, context) {
...
function createTestEmailTemplate() {
    const subject = `Test configuration email - ${(0, branding_core_1.getShortAppName)()}`;
    const html = `
    <!DOCTYPE html>
    <html>
    <head>
...
function createNewMemberProposalEmailTemplate(memberData, context) {
    ...
    <body style="margin: 0; padding: 20px; background-color: #f5f5f5;">
      <div style="${emailStyles.container}">
        ...
        <main style="${emailStyles.content}">
          ...
          <div style="${emailStyles.note}">
            Ce nouveau membre a été suggéré et attend votre contact pour intégrer ${branding_core_1.brandingCore.organization.name}.
          </div>
        </main>
...
function createNewLoanItemEmailTemplate(loanItem, context) {
