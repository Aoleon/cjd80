...
exports.FirebaseDumpParser = void 0;
const fs_1 = require("fs");
class FirebaseDumpParser {
    static parseFirebaseDump(filePath) {
    ...
    static parseInsertStatement(line, table) {
...
exports.FirebaseDumpParser = FirebaseDumpParser;
